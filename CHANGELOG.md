...
- Preserve 0.2.1+ concept documents while the product face selects patch-specific admission gates; fail strict on the legacy 0.2.0 baseline or documents newer than the installed validator.
